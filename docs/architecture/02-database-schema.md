...
| `permissions` | `key TEXT NOT NULL`, `resource TEXT NOT NULL`, `action TEXT NOT NULL`, `description TEXT NOT NULL`, `created_at TIMESTAMPTZ NOT NULL`. **PK** `(key)`. **Exactly 72 rows**, seeded from `src/lib/rbac/catalogue.ts` (`11 §1.3`) |
