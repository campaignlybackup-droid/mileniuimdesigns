  ...
  return (
    <Link
      ...
      style={{
        ...
        overflow: "hidden",
        padding: isFeatured ? "clamp(10px, 2vw, 18px)" : "clamp(6px, 1.5vw, 12px)",
    ...
    >
      ...
      <div
        style={{
          paddingTop: isFeatured ? "clamp(8px, 1.8vw, 16px)" : "clamp(6px, 1.4vw, 10px)",
          display: "flex",
          flexDirection: "column",
        ...
        <div>
          ...
          <h3
            style={{
              ...
              fontSize: isFeatured ? "clamp(1.25rem, 2.4vw, 2rem)" : isWide ? "clamp(0.9375rem, 1.8vw, 1.2rem)" : "clamp(0.8125rem, 1.8vw, 1.0625rem)",
              fontWeight: 400,
